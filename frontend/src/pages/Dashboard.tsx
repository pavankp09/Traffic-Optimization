...
import { XaiLiveCanvas } from '../components/canvas/XaiLiveCanvas'
import { TrainingModeSelector, type TrainingMode } from '../components/config/TrainingModeSelector'
import SplitCanvas from '../components/canvas/SplitCanvas'
import RLConfigDetailsPanel from '../components/config/RLConfigDetailsPanel'
import RLTrainingHUD from '../components/training/RLTrainingHUD'
import KpiCards from '../components/kpi/KpiCards'
import EconomicProjector from '../components/kpi/EconomicProjector'
import TrainingChart from '../components/charts/TrainingChart'
import TrainingExplainer from '../components/explainability/TrainingExplainer'
import InsightCards from '../components/training/InsightCards'
import ConvergenceIndicator from '../components/training/ConvergenceIndicator'
import XaiPanel from '../components/explainability/XaiPanel'
import SimConfigPanel from '../components/config/SimConfigPanel'
import ConfigModal from '../components/config/ConfigModal'
import SimStatsPanel from '../components/kpi/SimStatsPanel'
import BeforeAfterChart from '../components/charts/BeforeAfterChart'
import QueueHeatmap from '../components/charts/QueueHeatmap'
import PhaseTimeline from '../components/training/PhaseTimeline'
import QuickDemoButton from '../components/shared/QuickDemoButton'
import SimLiveStatsPanel from '../components/kpi/SimLiveStatsPanel'
import RLNeuralPanel from '../components/training/RLNeuralPanel'
import { XaiDecisionSidebar } from '../components/explainability/XaiDecisionSidebar'
