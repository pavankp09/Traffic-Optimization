...
from backend.services.rl.envs.traffic_env import make_env
...
class DecisionCaptureCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        try:
            import torch
            from backend.services.rl.envs.mock_env import OBS_LABELS, PHASE_NAMES, DURATIONS, N_DURATIONS
...
class PPOTrainer:
    ...
    def __init__(
        ...
        adverse_config: AdverseConfig,
        session_id: str,
        db_url: str = "sqlite:///backend/db/data/traffic.db",
